    ...
    <>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="col-span-1 md:col-span-2 lg:col-span-2 row-span-2">
                <div class="rounded-2xl bg-gray-700/40 backdrop-blur-sm ring-1 ring-white/10 h-full transition-all hover:bg-gray-700/60 duration-300">
                    <div class="aspect-video rounded-t-2xl overflow-hidden">
                        <iframe class="w-full h-full" src="https://www.youtube.com/embed/F2X9jjCT17E?si=3rQt4qJfLFnfQT7e" allow="autoplay; fullscreen; picture-in-picture">
                        </iframe>
                    </div>
                    <div class="p-6">
                        <h3 class="text-sm font-semibold text-gray-400">{ "Welcome to CodeOps HQ" }</h3>
                        <p class="mt-2 text-xl font-medium text-white">{ "Love What You Build" }</p>
                    </div>
                </div>
            </div>

            <div class="col-span-1">
                <div class="rounded-2xl bg-gray-600/30 backdrop-blur-sm ring-1 ring-white/10 p-6 transition-all hover:bg-gray-600/50 duration-300">
